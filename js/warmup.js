window.Warmup = {
  ...
  initialize: function () {
    ...
    */
    showNamesForSelector("#under-isaiah-button", "#root > li:first-child > ul");

    /*
      Description: show the names of the people under Eulalia
      Outcome: Claude, Lowell
    */
    showNamesForSelector("#under-eulalia-button", "#root > li:last-child > ul");

    /*
      Description: values of all of the input fields of type text
      Outcome: Joe, Example
    */
    showValuesForSelector("#text-field-button", "input:text");
